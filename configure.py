...
def parse_args():
    ...
    # Data loading params
    parser.add_argument("--train_path", default="../data/SemEval2010_task8_training/TRAIN_FILE.TXT",
                        type=str, help="Path of train data")
    parser.add_argument("--test_path", default="../data/SemEval2010_task8_testing_keys/TEST_FILE_FULL.TXT",
    ...
    # Testing parameters
    parser.add_argument("--checkpoint_dir", default="./runs/1558404791/checkpoints/",
