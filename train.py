...
from att_blstm import ATT_BLSTM
import utils
...
def train():
    with tf.device('/cpu:0'):
        x_text, y = utils.load_data_and_labels(FLAGS.train_path)
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            model = ATT_BLSTM(
                ...
                vocab_dim=len(vocab_processor.vocabulary_),
            ...
            for batch in batches:
                ...
                feed_dict = {
                    ...
                    model.embed_dropout_keep_prob: FLAGS.emb_dropout_keep_prob,
                ...
                if step % FLAGS.evaluate_every == 0:
                    ...
                    feed_dict = {
                        ...
                        model.input_y: y_dev,
                        model.embed_dropout_keep_prob: 1.0,
                        model.rnn_dropout_keep_prob: 1.0,
                        model.dropout_keep_prob: 1.0
                    }
                    summaries, loss, accuracy, predictions = sess.run(
                        [dev_summary_op, model.loss, model.accuracy, model.prediction], feed_dict)
